				...
				<div style="margin-top: -50px;" class="container">
					...
					<form id="regForm" method="POST" action="cadastrar_cliente.php">
						...
						<div class="tab" value="0">
							<center><div><h3>Cadastro do Aluno</h3> </div></center>
						...
						<div class="tab" value="2">
							...
							<input class="form-control"  id="nome" name="nome"  minlength="6" type="text" required>
							</div>
							<div class="form-group col-md-6">
								<h5 style="display:  inline-block;">
								<label for="inputPassword4">Sobrenome:</h5></label>
							<input class="form-control"  id="sobrenome" name="sobrenome"  minlength="6" type="text" required>
							</div>
						</div>
							<div class="form-row">
								<div class="form-group col-md-6">
							...
							<input class="form-control"  id="cpf" name="cpf"  minlength="6" type="text" placeholder="XXX.XXX.XXX-XX" required>
							</div>
							<div class="form-group col-md-6">
								<h5 style="display:  inline-block;">
								<label for="inputAddress2">RG:</h5></label>
							<input class="form-control"  id="rg" name="rg"  type="text" placeholder="XX.XXX.XXX-X" required>
							</div>
							</div>
							<div class="form-row">
								<div class="form-group col-md-6">
						...
						<div class="tab">
							...
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="inputPassword4">Número(Residência):*</label>
						...
						<div class="tab">
							...
							<div class="form-row">
								...
								<div class="form-group col-md-6">
									...
									<input class="form-control telefone" type="text" name="celular" id="celular"  placeholder="00 00000-0000" >
								</div>
							</div>
						</div>
