          ...
          <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="visualizar_cursos_professor.php" >Cursos interessados dos Alunos
                  </a>
                </li>
              ...
              <div class="col">
                <div class="row">
                  <div class="col-sm" id="escondido" style="display: none;">
                   ...
                   <br>
                   <center><h4>Escolha a disciplina e as suas disponibilidades para dar aula.</h4></center>
                   <form method="POST" action="cadastrar_curso.php">
                    <div class="row">
                     ...
                     </option><option value="Professor">Professor
                     </option>
                   </select></div>
                   <div class="col-4"> Disciplina: <select name="disciplina" style="" class="form-control" id="disciplina" required> <option value="">Selecione um disciplina.
                   ...
                   <div class="col-4"> Tempo do Curso: <select  class="form-control year" name="tempo_curso" id="year" required>
                    ...
                    <div class="col-4">
                            <input type="hidden" value="" name="cobranca" id="hcobranca">
                            Tipo de Cobrança:
                            <select  name="cobranca" class="form-control marcas selectpicker" data-live-search="true" id="cobranca" required>
                    ...
                    <div class="col-4">
                            ...
                            Preço:
                            <select class="form-control modelo" name="preco" id="preco" required>
                              <option value="">Selecione a média do valor.</option>
                              <option value="De 300 a 800 R$">De  300 a  800 R$</option>
                              <option value="De  1000 a  2000 R$">De  1000 a  2000 R$</option>
                              <option value="De  3000 a  4000 R$">De  3000 a  4000 R$</option>
                              <option value="De  5000 a  9000 R$">De  5000 a  9000 R$</option>
                            </select>
                    </div>
                  </div>
                  ...
                  <div class="row">
                    ...
                    </option><option value="Iniciante">Básico I
                      </option><option value="Iniciante">Básico II
                    </option><option value="Intermediário">Intermediário I
                      </option><option value="Intermediário">Intermediário II
                    </option><option value="Avançado">Avançado I
                      </option><option value="Avançado">Avançado II
                    </option> </select> </div>
                  ...
                  <div class="col-sm" id="escondido2" style="display: block;">
                    <br>
                    <center><h4>Seus cursos aparecerão na lista abaixo.</h4></center>
                    <br>
                    <ul style="text-align: left;" class="list-group">
                      ...
                      while ($vetor_curso = mysqli_fetch_array($curso_resultado)) {
                        ...
                        <h5 class='modal-title' id='exampleModalLabel'>Altere as informações do curso aqui.  Disciplina: ".$vetor_curso['disciplina']."</h5>
                        <button type='button' class='close' data-dismiss='modal' aria-label='Close'>
                        <span aria-hidden='true'>&times;</span>
                        </button>
                        </div>
                        <div class='modal-body'>
                        <form method='POST' action='alterar_curso_professor.php'>
                        <div class='row'>
                       <div class='col-6'>
                        Nível:
                         ...
                         <div class='col-6'>
                        Cobrança:
                          <select name='cobranca' class='form-control marcas selectpicker' value='".$vetor_curso['cobranca']."'>
                         <option value='".$vetor_curso['cobranca']."'>Selecione um tipo de cobrança.
                   </option><option value='Preço Fixo'>Preço Fixo
                   </option><option value='A combinar'>A combinar
                   </option> </select>
                        </div>
                         <div class='col-6'>
                        Preço:
                          <select name='preco' class='form-control' value='".$vetor_curso['preco']."'>
                         <option value='".$vetor_curso['preco']."'>Selecione a média do valor.
                   <option value='De  300 a  800 R$'>De  300 a  800 R$</option>
                              <option value='De  1000 a  2000 R$'>De  1000 a  2000 R$</option>
                              <option value='De  3000 a  4000 R$'>De  3000 a  4000 R$</option>
                              <option value='De  5000 a  9000 R$'>De  5000 a  9000 R$
                   </option> </select>
                        </div>
                        <div class='col-4'> Tempo do Curso:
                        ...
                        <a class='btn btn-terciary' href='cursos_professor.php'>Cancelar</a>
