...
$cepn = soNumero($cep);
    ...
    if($numero == 0 && $numero_cliente == 0){
        ...
        if($resultado_login)
        {
            ...
            $sql_cliente = "INSERT INTO `cliente`(`cod_login`, `nome`, `email`, `rg`, `cpf`, `rua`, `estado`, `cep`, `cidade`, `telefone`, `bairro`, `complemento`, `sobrenome`, `numero`, `celular`,`data_nascimento`) VALUES ($cod_login,'$nome','$email',$rgn,'$cpf','$rua','$estado',$cepn,'$cidade',$telefonen,'$bairro','$complemento','$sobrenome',$numero2,$celularn,'$data_nascimento')";
