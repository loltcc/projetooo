...
if (isset ($_POST['senha'])) {
  ...
  ?>
    ...
    $celular =  soNumero($_POST['celular']);
        ...
        $sql_pesquisa ="UPDATE `cliente` SET `rua`='$rua',`estado`='$estado',`cep`=$cep,`cidade`='$cidade',`telefone`='$telefone',`bairro`='$bairro',`complemento`= '$complemento',`email`= '$email',`numero`='$numero',`celular`='$celular' WHERE `cod_login` = $cod_login" ;
