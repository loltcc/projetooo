...
if(!isset($_SESSION["system_control"]))
{
  ...
  if($system_control == 1 && $privilegio == 0){
    ...
    $sql_curso ="SELECT * FROM `curso` WHERE `cod_professor` != 0" ;
          ...
          <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
              <ul class="nav flex-column">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="meus_cursos.php">Voltar</a>
                </li>
                </li>
                    ...
                    <br>
                    <br>
                    <center><h4>Escolha um curso que você deseja e entre em contato com um professor.</h4></center>
                   <br>
