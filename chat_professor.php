...
$(document).ready(function(){
 ...
 function make_chat_dialog_box(to_user_id, to_user_name)
 {
  ...
  modal_content += fetch_professor_chat_history(to_user_id);
  modal_content += '</div>';
 ...
 function fetch_professor_chat_history(to_user_id)
 {
  $.ajax({
   url:"fetch_professor_chat_history.php",
   method:"POST",
 ...
 function update_chat_history_data()
 {
  $('.chat_history').each(function(){
   var to_user_id = $(this).data('touserid');
   fetch_professor_chat_history(to_user_id);
  });
 }
