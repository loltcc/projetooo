...
if (isset ($_POST['senha'])) {
  ...
  ?>
    <script>
      ...
      document.location.href="form_alterar_professor.php";
    </script>
    <?php  
    ...
    $celular =  soNumero($_POST['celular']);
        ...
        $sql_pesquisa ="UPDATE `professor` SET `rua`='$rua',`estado`='$estado',`cep`=$cep,`cidade`='$cidade',`telefone`='$telefone',`bairro`='$bairro',`complemento`= '$complemento', `especializacao`= '$especializacao',`email`= '$email',`numero`='$numero',`celular`='$celular' WHERE `cod_login` = $cod_login";
