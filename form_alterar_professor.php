      ...
      <nav class="col-md-2 d-none d-md-block bg-light sidebar">
          ...
          <ul class="nav flex-column">
            <li class="nav-item">
              ...
              <a class="nav-link active" href="#" style="color: #ff0000">
                ...
                Seu Perfil <span class="sr-only">(current)</span>
              </a>
       ...
       <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
        <div style="" class="container">
          ...
          <form method="POST" action="alterar_professor.php" id="alterar">
            ...
            <div class="form-row">
              ...
              <div class="form-group col-md-2">
                ...
                <div id="especializacao"><?php echo $vetor['especializacao']; ?></div>
              </div>  
              <div class="form-group col-md-4">
                <label for="inputPassword4">E-mail:</label>
                <div id="email"><?php echo $vetor['email']; ?></div>
              </div>  

            </div>
            <div id="botoes" style="display: none">
            <center><a href="perfil_professor.php" class="btn btn-primary">Voltar</a> <button type="button" class="btn btn-primary" id="enviar">
              Enviar
            </button></center></div>
    ...
    <div class="modal fade" id="alterar_senha" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="alterar_professor.php" id="form">
      ...
      <div class="modal fade" id="alterar_foto" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form method="post" enctype="multipart/form-data" action="foto_professor.php">
              ...
              <script type="text/javascript">
                function enviar() {
                  ...
                  if (senha == "" || senha_nova == "" || c_senha_nova == "") {
                    ...
                    } else if (senha_nova.length < 4) {
                      alert("A sua senha deve ter no mínimo 4 caracteres")
                    } else {
              ...
              <script>
                ...
                $( "body" ).delegate( ".telefone", "myCustomEvent", function( e, myName, myValue ) {
                  ...
                  $("#rua").replaceWith("<input value='<?php echo $vetor['rua']; ?>' id='rua' name='rua' type='text' class='form-control'>");
                   ...
                   $("#especializacao").replaceWith("<input value='<?php echo $vetor['especializacao']; ?>' type='text' name='especializacao' class='form-control'>");
                    $("#email").replaceWith("<input value='<?php echo $vetor['email']; ?>' type='text' name='email' class='form-control'>");
